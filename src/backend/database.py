...
initial_announcements = [
    {
        "message": "🎉 Activity registration is open! Sign up before spots fill up — don't miss your chance to join a club or team this semester.",
        "start_date": None,
        "expiration_date": datetime(2026, 12, 31, 23, 59, 59, tzinfo=timezone.utc).isoformat(),
